$(async function () {
    ...
    if (!showId)
        return window.location.href = ('/movie-grid.html')
    ...
    $(".back-button").attr("href", "/movie-ticket-plan.html?movie-id=" + encodeURI(show.movieId))
    ...
    $("#create").click(async () => {
        ...
        return window.location.href = ('/movie-checkout.html?booking-id=' + encodeURIComponent(booking.id))
    })

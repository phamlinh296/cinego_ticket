...
// Thêm hàm này vào cuối file requestAPI.js
const GetUserIdFromToken = function() {
    let token = GetToken();
    if (!token) return null;
    try {
        // Decode base64 phần payload của JWT
        ...
        return decoded.sub; // Hoặc decoded.userId tùy vào cách bạn set trong JWT ở Backend
    } catch (e) {
        return null;
    }
}

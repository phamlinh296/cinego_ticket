...
//AnalyticsConsumer → gọi AnalyticsProcessor
//  → tính revenue, top movies vào Redis
//  → Spark AnalyticsJob làm CHÍNH XÁC việc này, tốt hơn
//  → có window aggregation thật sự, không phải chỉ INCR Redis